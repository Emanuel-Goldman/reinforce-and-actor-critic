#!/usr/bin/env python3
"""Training script for REINFORCE with baseline (variance reduction)"""
...
class REINFORCEBaseline:
    ...
    def __init__(self, obs_dim: int, action_dim: int, hidden_sizes: list = [128, 128],
                 ...
                 normalize_advantages: bool = False, entropy_coef: float = 0.0, device: str = "cpu"):
    ...
    def update(self) -> dict:
        ...
        returns = compute_returns(self.buffer.rewards, self.gamma, normalize=False).to(self.device)
...
def main():
    ...
    if args.log_dir is None:
        args.log_dir = f"results/reinforce_baseline/tensorboard/seed_{args.seed}"
    if args.artifact_dir is None:
        args.artifact_dir = f"results/reinforce_baseline"
