#!/usr/bin/env python3
"""Training script for basic REINFORCE algorithm"""
...
from src.pg.reinforce import REINFORCE
...
def main():
    ...
    if args.log_dir is None:
        args.log_dir = f"artifacts/section1_basic_reinforce/tensorboard/seed_{args.seed}"
    if args.artifact_dir is None:
        args.artifact_dir = f"artifacts/section1_basic_reinforce"
    ...
    threshold = 475.0  # CartPole-v1 threshold (adjust for other envs)
